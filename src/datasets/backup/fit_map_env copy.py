...
class FITMapEnv(object):
    def __init__(self, map_data_path,
        ...
        self.road_layers = ['drivable_area']
        self.num_layers = 1
        ...
        # lanelet_path = "/home/user/lanelet_ws/src/maps/Town03_trans.osm"
        # lanelet_path = "/home/hj/Carla_HB/carla-autoware-universe/src/carla_map/maps/vector_maps/lanelet2/HMCL_Racing_Odom_shifted.osm"
        # shp_path = '/home/hj/Carla_HB/script/rasterized_image/hmcl_racing/shp'
        
        lanelet_path = '/home/hj/Carla_HB/script/map/centerline_added_boston.osm'
        shp_path = '/home/hj/Carla_HB/script/rasterized_image/boston_seaport/shp'

        self.nusc_raster = futils.fit_raster(lanelet_path, shp_path)
        # print("!!!! raster !!!! :")
