...
def add_base_args(parser):
    ...
    parser.add_argument('--dt', type=float, default=0.5, help='Time interval between logs')
    
    parser.add_argument('--start_num', type=int, default=0, help='Start scenario number')
