...
class EnvPotentialLoss(nn.Module):
    ...
    def forward(self, pred_traj, scene_graph, map_idx, map_env):
        ...
        ego_traj = pred_traj_unnorm[ego_inds]  # (B, FT, 4)
        ...
        for t in range(FT):
            ...
            if has_lane_lines:
                ...
                if torch.sum(valid_solid) > 0:
                    ego_pos = ego_state_t[valid_solid, :2]
            ...
            if has_lane_lines:
                ...
                if torch.sum(valid_dashed) > 0:
                    ego_pos = ego_state_t[valid_dashed, :2]
...
class TrafficPlannerLoss(nn.Module):
    ...
    def __init__(self, loss_weights,
        ...
        :param loss_weights: dict of weightings for loss terms
            ...
            - potential_veh: vehicle repulsion potential weight (ego-only, requires use_potential_loss=True)
        ...
        :param use_potential_loss: enable potential-based repulsion loss (default True)
